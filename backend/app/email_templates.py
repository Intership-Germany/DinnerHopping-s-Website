...
DEFAULT_TEMPLATES = [
    ...
    },
    {
        ...
        'html_body': (
            '<div style="font-family: -apple-system, system-ui, Roboto, \"Helvetica Neue\", Arial, sans-serif; color:#111; line-height:1.6;">'
            '<p style="font-size:16px; margin:0 0 12px 0;">Hi!</p>'
            '<p style="margin:0 0 12px 0;">Your registration for <strong>{{event_title}}</strong> is confirmed.</p>'
            '<p style="margin:0 0 12px 0;">Event date: {{event_date}}</p>'
            '<p style="margin-top:12px; color:#374151;">You\'ll receive your detailed schedule closer to the event.</p>'
            '<p style="margin-top:18px; color:#6b7280;">Have fun!<br/>— DinnerHopping Team</p>'
            '</div>'
        ),
    ...
    },
    {
        ...
        'html_body': (
            '<div style="font-family: -apple-system, system-ui, Roboto, \"Helvetica Neue\", Arial, sans-serif; color:#111; line-height:1.6;">'
            '<p style="font-size:16px; margin:0 0 12px 0;">Hi!</p>'
            '<p style="margin:0 0 12px 0;">Your registration for <strong>{{event_title}}</strong> has been cancelled.</p>'
            '<p style="margin:0 0 12px 0;">Refund processing: {{refund}}</p>'
            '<p style="margin-top:18px; color:#6b7280;">— DinnerHopping Team</p>'
            '</div>'
        ),
    ...
    },
    {
        ...
        'html_body': (
            '<div style="font-family: -apple-system, system-ui, Roboto, \"Helvetica Neue\", Arial, sans-serif; color:#111; line-height:1.6;">'
            '<p style="font-size:16px; margin:0 0 12px 0;">Hi!</p>'
            '<p style="margin:0 0 12px 0;">Your partner cancelled their participation for <strong>{{event_title}}</strong>.</p>'
            '<p style="margin:0 0 12px 0;">You can invite a replacement or cancel the team in your dashboard.</p>'
            '<p style="margin-top:18px; color:#6b7280;">— DinnerHopping Team</p>'
            '</div>'
        ),
    ...
    },
    {
        ...
        'html_body': (
            '<div style="font-family: -apple-system, system-ui, Roboto, \"Helvetica Neue\", Arial, sans-serif; color:#111; line-height:1.6;">'
            '<p style="font-size:16px; margin:0 0 12px 0;">Hi!</p>'
            '<p style="margin:0 0 12px 0;">The team composition for <strong>{{event_title}}</strong> changed.</p>'
            '<p style="margin:0 0 6px 0;">New partner: {{new_partner_email}}</p>'
            '<p style="margin:0 0 12px 0;">Replaced partner: {{old_partner_email}}</p>'
            '<p style="margin-top:18px; color:#6b7280;">— DinnerHopping Team</p>'
            '</div>'
        ),
    ...
    },
    {
        ...
        'html_body': (
            '<div style="font-family: -apple-system, system-ui, Roboto, \"Helvetica Neue\", Arial, sans-serif; color:#111; line-height:1.6;">\n'
            '<p style="font-size:16px; margin:0 0 12px 0;">Hi!</p>\n'
            '<p style="margin:0 0 12px 0;">You have been invited to join an event on DinnerHopping for <strong>{{event_title}}</strong>.</p>\n'
            '<p style="margin:0 0 12px 0;">To accept the invitation, click the button below:</p>\n'
            '<p style="margin:0 0 16px 0;">\n'
            '<a href="{{invitation_link}}" style="display:inline-block; background-color:#10b981; color:#fff; text-decoration:none; padding:10px 16px; border-radius:6px; font-weight:600;">Accept invitation</a>\n'
            '</p>\n'
    ...
    },
    {
        ...
        'html_body': (
            '<div style="font-family: -apple-system, system-ui, Roboto, \"Helvetica Neue\", Arial, sans-serif; color:#111; line-height:1.6;">\n'
            '<p style="font-size:16px; margin:0 0 12px 0;">Hi!</p>\n'
            '<p style="margin:0 0 12px 0;">You were added to a team for the event <strong>{{event_title}}</strong>.</p>\n'
            '<p style="margin:0 0 12px 0;">To confirm your participation, please click the <em>Accept invitation</em> link in the invitation email sent to you. If you do not have an account yet, one may be created for you and you will receive a separate email with a secure link to set your password.</p>\n'
            '<p style="margin:0 0 12px 0;">If you cannot participate, decline here:</p>\n'
            '<p style="margin:0 0 16px 0;">\n'
            '<a href="{{decline_link}}" style="display:inline-block; background-color:#f59e0b; color:#fff; text-decoration:none; padding:10px 16px; border-radius:6px; font-weight:600;">Decline</a>\n'
            '</p>\n'
            '<p style="margin-top:12px; color:#6b7280;">If the button does not work, copy and paste the following link into your browser:</p>\n'
            '<p style="font-size:13px; word-break:break-all;"><a href="{{decline_link}}" style="color:#2563eb; text-decoration:underline;">{{decline_link}}</a></p>\n'
            '<p style="margin-top:18px; color:#6b7280;">— DinnerHopping Team</p>\n'
            '</div>'
        ),
